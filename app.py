...
<head>
    ...
    <style>
        ...
        .search-wrapper { max-width: 800px; margin: 0 auto; display: flex; gap: 0; }
        ...
        button { 
            ...
            letter-spacing: 1px; font-size: 14px; white-space: nowrap;
        }
...
<body>
    ...
    <div id="loader" class="loader">Analisando dados...</div>

    <div id="main-map"></div>

    <div class="search-section">
        <div class="search-wrapper">
            <input type="text" id="buscaInput" placeholder="DIGITE O NOME DA CIDADE, LOJA OU CEP...">
    ...
    <script>
        ...
        function realizarBusca() {
            ...
            // Verifica se é CEP (8 dígitos, com ou sem traço)
            // Regex: Começa com 5 digitos, traço opcional, termina com 3 digitos
            let padraoCep = /^[0-9]{5}-?[0-9]{3}$/;

            if(padraoCep.test(termo)) {
                buscarCep(termo.replace('-', ''));
            } else {
                buscarTexto(termo);
            }
        }
...
# --- HTML ADMIN (Mantido igual por segurança) ---
HTML_ADMIN = """
<!DOCTYPE html>
<html>
<head>
